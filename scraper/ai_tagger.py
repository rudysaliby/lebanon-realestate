...
SYSTEM = """You are a Lebanese real estate data extractor. Extract structured tags from listing title and description.
...

{
  ...
  "view": ["sea"] and/or ["mountain"] and/or ["open"] and/or ["city"] and/or ["garden"] — array, empty if none,
  "floor_type": "rooftop" | "penthouse" | "duplex" | "triplex" | "ground" | "high-floor" | null,
  "bedrooms": number or null,
  "bathrooms": number or null,
  "features": array of strings from: ["pool","garden","terrace","parking","elevator","generator","storage","gym","balcony","sea-access","solar","security"],
